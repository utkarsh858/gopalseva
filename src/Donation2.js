...
var yyyy = today.getFullYear();
    ...
    return (
        ...
        <form class="needs-validation" target="_blank" method="post" action="https://us-central1-gopal-seva.cloudfunctions.net/api/data" enctype='application/json' novalidate>
