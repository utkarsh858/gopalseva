	...
	return(
          ...
          <div >
            <div style={{position:"absolute",bottom:0,zIndex:-1}}>
                  ...
                  <section style={{zIndex:-1}} class="l-section wpb_row height_large color_secondary with_img with_overlay with_shape parallax_fixed" id="contact">

                      <div class="l-section-img loaded" style={{zIndex:-1, backgroundImage: "url(" + imgUrl + ")" }} data-img-width="1280" data-img-height="754">
                      </div>


                      <div class="l-section-overlay" style={{zIndex:-1, background: "rgba(0,0,0,0.65)"}}></div>
                              ...
                              <div class="animate_afb animate_start">
                                  <div>
                                      <div>
                                          <div >
                                              <div>
                                                  <p>For non-Indian passport holders: Due to financial rules of the government, non-Indian passport holders can donate only through the FCRA accounts. Please use the contact form below if you need any assistace in this connection.

                                                  </p>

                                                  <h2 style={{ textAlign: "center" }} class="highlight highlight_primary">
                                                      CONTACT US 
                                                  </h2>
                                              </div>
                                          </div>
                                                  ...
                                                  <div class="vc_column-inner">
                                                      <div class="wpb_wrapper">
                                                          <div class="wpb_text_column">
                                                              <div class="wpb_wrapper">
                                                                  <h3>Registered Head Office: ISKCON, Hare Krishna Land, Juhu, Mumbai.</h3>
                                                              </div>
                                                          </div>
                                                          ...
                                                          <div class="w-iconbox iconpos_left style_circle color_primary align_left no_text">
                                                              <div class="w-iconbox-icon" style={{ fontSize: "120%" }}>
                                                                  <i class="fa fa-phone"></i>
                                                              </div>

                                                              <div class="w-iconbox-meta">
                                                                  <h3 class="w-iconbox-title">+91 9654 789 832</h3>
                                                              </div>
                                                          </div>
                                                          ...
                                                          <div class="w-iconbox iconpos_left style_circle color_primary align_left no_text">
                                                              ...
                                                              <div class="w-iconbox-meta">
                                                                  <h3 class="w-iconbox-title">yudhistir@iskcon.org</h3>
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
